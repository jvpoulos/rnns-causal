...
%		\includegraphics[width=\textwidth]{plots/california-sim.png}
	...
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		%		\includegraphics[width=\textwidth]{plots/educ-sim.png}
		\caption{Education spending data, $\text{N}_t = 8$}
	\end{subfigure}
	~ 
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
