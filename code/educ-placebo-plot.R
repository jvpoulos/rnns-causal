...
ggsave("results/plots/educ-sim-slides.png", educ + ggtitle("Education spending, discarding treated units") + theme(plot.title = element_text(family="serif", size=16, hjust = 0.5)))

# Discarding treated periods

load("results/plots/educ_pc_alt_N_32_T_86_numruns_25_num_treated_16_simultaneuous_1.rds")
...
ggsave("results/plots/educ-sim-alt.png", educ + theme( legend.position = "none"), width=8.5, height=11)
ggsave("results/plots/educ-sim-altslides.png", educ + ggtitle("Education spending, discardign treated periods") + theme(plot.title = element_text(family="serif", size=16, hjust = 0.5)))
