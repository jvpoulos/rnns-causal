...
ggsave(paste0(results.directory, "plots/basque-sim.png"), basque, width=8.5, height=11)
...
ggsave(paste0(results.directory, "plots/germany-sim.png"), germany, width=8.5, height=11)
...
ggsave(paste0(results.directory, "plots/california-sim.png"), california, width=8.5, height=11)