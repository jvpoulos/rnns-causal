...
rae <- function(Y_obs,Y,treat_indices,d, t0, T){
  ...
  source_python("code/train_rae_sim.py")
  
  rae.pred <- as.matrix(read_csv(paste0("results/rae/",d,"/rae-",d,"-test.csv"), col_names = FALSE))
