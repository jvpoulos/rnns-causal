...
if __name__ == "__main__":
    ...
    weights_path = 'results/rvae/{}'.format(dataname) +'/weights-placebo-{}-{}.h5'.format(str(n_pre), str(nb_features))
    ...
    # save weights
    vae.save_weights('results/rvae/{}'.format(dataname) +'/weights-placebo-{}-{}.h5'.format(str(n_pre),str(nb_features)))
